--- src/components/HUD/WidgetHubModal.tsx (原始)
...
+++ src/components/HUD/WidgetHubModal.tsx (修改后)
import React from 'react';
import { X, Swords, Timer, Dice3, FileText, Eye, CloudSun, UserPlus, Map, Skull, BookOpen, Dices, Users } from 'lucide-react';
...
export const WidgetHubModal: React.FC<Props> = ({ onClose, onOpenTracker, onOpenClockConfig, onOpenOracleV2, onOpenNPCGenerator, onOpenLocationGenerator, onOpenEncounterGenerator, onOpenCampaignManager, onOpenAutomatedDice, onOpenCharacterRoster }) => {
  return (
    <div className="glass-panel animate-fade-in" style={{ padding: '1.5rem', width: '550px' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '1.5rem', alignItems: 'center' }}>
        <h3 style={{ margin: 0, color: 'var(--text-primary)', fontSize: '1.2rem', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>

...
export const WIDGET_REGISTRY: WidgetMeta[] = [
  ...
  { id: 'players', cat: 'Game Master', title: 'Controle de Jogadores (GM)', description: 'Central administrativa para gerenciar conexões, vincular fichas/tokens, puxar visão e solicitar testes', icon: Users, theme: 'theme-indigo', shadow: '0 0 12px rgba(99,102,241,0.4)', actionType: 'toggleWindow', actionPayload: 'playerManager' },

...
interface ActionDef {
  ...
  category: 'GameMaster' | 'PlayerTools' | 'Generators' | 'System';
  onSelect: () => void;
}
...
export const CommandPalette: React.FC = () => {
  ...
  const recentActions = recentIds.map(id => actions.find(a => a.id === id)).filter(Boolean) as ActionDef[];

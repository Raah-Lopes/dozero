...
// Lazy loaded widgets
const OracleWidgetV2 = React.lazy(() => import('./OracleWidgetV2').then(m => ({ default: m.OracleWidgetV2 })));
const NPCGeneratorWidget = React.lazy(() => import('./NPCGeneratorWidget').then(m => ({ default: m.NPCGeneratorWidget })));
const LocationGeneratorWidget = React.lazy(() => import('./LocationGeneratorWidget').then(m => ({ default: m.LocationGeneratorWidget })));
const EncounterWidget = React.lazy(() => import('./EncounterWidget').then(m => ({ default: m.EncounterWidget })));
const CampaignManagerWidget = React.lazy(() => import('./CampaignManagerWidget').then(m => ({ default: m.CampaignManagerWidget })));
const MapasMentaisWidget = React.lazy(() => import('./MindMapWidget').then(m => ({ default: m.MapasMentaisWidget })));
const AutomatedDiceWidget = React.lazy(() => import('./AutomatedDiceWidget').then(m => ({ default: m.AutomatedDiceWidget })));
const CharacterRosterWidget = React.lazy(() => import('./CharacterRosterWidget').then(m => ({ default: m.CharacterRosterWidget })));
const ChronosWidget = React.lazy(() => import('./ChronosWidget').then(m => ({ default: m.ChronosWidget })));
const LoreMachineWidget = React.lazy(() => import('./LoreMachineWidget').then(m => ({ default: m.LoreMachineWidget })));
const DLCManagerWidget = React.lazy(() => import('./DLCManagerWidget').then(m => ({ default: m.DLCManagerWidget })));
const WorldEngineWidget = React.lazy(() => import('./WorldEngineWidget').then(m => ({ default: m.WorldEngineWidget })));
...
const DiceRollerWidget = React.lazy(() => import('./DiceRollerWidget').then(m => ({ default: m.DiceRollerWidget })));

...
export const AI_MODELS: AIModel[] = [
  ...
  { id: 'gemini-2.5-flash', label: 'Gemini 2.5 Flash', provider: 'gemini', requiresKey: true, free: true, contextWindow: 2000000 },
  { id: 'gemini-2.0-flash', label: 'Gemini 2.0 Flash', provider: 'gemini', requiresKey: true, free: true, contextWindow: 1000000 },
  { id: 'gemini-flash-latest', label: 'Gemini Flash (Latest)', provider: 'gemini', requiresKey: true, free: true, contextWindow: 2000000 },
  { id: 'gemini-pro-latest', label: 'Gemini Pro (Latest)', provider: 'gemini', requiresKey: true, free: false, contextWindow: 4000000 },
